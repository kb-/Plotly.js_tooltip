...
Tooltip annotations let users click data points and create persistent Plotly annotations from the modebar. It is inspired by Matlab datatip.
The feature supports three customization layers:
